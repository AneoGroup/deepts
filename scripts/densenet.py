...
from tensorflow.keras.layers import Dense, Dropout, Activation, Conv2D, AveragePooling2D, GlobalAveragePooling2D, Input, Concatenate, BatchNormalization
...
def DenseNet(nb_classes, img_dim, depth, nb_dense_block, growth_rate,
    ...
    # Add dense blocks
    for tmp_idx, block_idx in enumerate(range(nb_dense_block - 1)):
