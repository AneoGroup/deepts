...
from lstm.lstm_network import DeepARLSTMPredictionNetwork, DeepARLSTMTrainingNetwork


class DeepARLSTMEstimator(GluonEstimator):
    """
    ...
    *Note:* the code of this model is unrelated to the implementation behind
    ...
    def create_training_network(self) -> DeepARLSTMTrainingNetwork:
        return DeepARLSTMTrainingNetwork(
    ...
    def create_predictor(
        ...
        prediction_network = DeepARLSTMPredictionNetwork(
...
if __name__ == "__main__":
    ...
    forecast_it, ts_it = make_evaluation_predictions(
        ...
        predictor=predictor,
        num_samples=1,  # number of samples we want to evaluate
    )
